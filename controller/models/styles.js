...
const stylesTable = async () => {
  ...
  try {
   ...
   const { tableset } = await sql.query` CREATE TABLE styles (id bigint IDENTITY(1,1) PRIMARY KEY CLUSTERED NOT NULL, productId bigint NOT NULL, name nvarchar(600)NOT NULL,
    sale_price bigint NULL, original_price bigint NULL, default_style bigint NOT NULL) `;
